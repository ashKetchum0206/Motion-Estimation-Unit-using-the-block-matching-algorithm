...
HD_PWD='C:/Users/hp/Desktop/Ultimate_Final/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log overall.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source overall.tcl
