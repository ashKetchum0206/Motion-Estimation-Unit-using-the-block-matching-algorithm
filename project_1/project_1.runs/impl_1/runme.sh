...
HD_PWD='C:/Users/hp/Desktop/Ultimate_Final/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log overall.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source overall.tcl -notrace
